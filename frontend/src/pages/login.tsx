      ...
      <div className="w-1/2 flex flex-col justify-center px-16 py-12">
        ...
        <div className="absolute bottom-6 left-8 flex items-center gap-1.5">
          ...
          <div>
            ...
            <div className="text-[9px] text-gray-400">v2.0.0</div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="relative z-10 w-72">
          ...
          <div className="rounded-3xl p-5 shadow-xl"
            ...
            <h2 className="text-xl font-bold text-white text-center mb-1">Iris AI</h2>
            <p className="text-sm text-orange-100 text-center mb-5">
              Vos emails Gmail analysés automatiquement. Détectez les rendez-vous et ajoutez-les en un clic à votre calendrier.
            </p>

            <div className="space-y-2">
              {[
                { label: "Détection IA des RDV", icon: "🤖", active: true },
                { label: "Gmail intégré", icon: "✉️", active: true },
                { label: "Google Calendar", icon: "📅", active: true },
                { label: "Réponses automatiques", icon: "⚡", active: true },
              ].map((item) => (
